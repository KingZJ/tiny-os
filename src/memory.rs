...
pub unsafe fn init(phsical_memory_offset: VirtAddr) -> OffsetPageTable<'static> {
    let l4_table = active_level_4_table(phsical_memory_offset);
    OffsetPageTable::new(l4_table, phsical_memory_offset)
}
...
pub fn create_example_mapping(
    ...
    let map_to_result = unsafe {
        // FIX: this is not safe, we do it only for testing
